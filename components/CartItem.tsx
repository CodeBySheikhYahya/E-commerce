    ...
    <tr className="hover:bg-gray-50">
      <td className="px-4 lg:px-6 py-4">
        <div className="flex items-center space-x-3">
          ...
          <h3 className="text-sm font-normal text-gray-900 whitespace-nowrap">
            {name}
          </h3>
        </div>
      </td>
        ...
        <div className="flex items-center justify-center">
          <div className="flex items-center border border-gray-300 rounded">
            ...
            <input
              ...
              value={quantity}
              readOnly
              className="w-10 lg:w-12 text-center border-x border-gray-300 py-1 lg:py-2 text-sm font-medium"
            />
            <button
              onClick={() => handleQuantityChange(quantity + 1)}
              className="px-2 lg:px-3 py-1 lg:py-2 hover:bg-gray-50 transition-colors"
